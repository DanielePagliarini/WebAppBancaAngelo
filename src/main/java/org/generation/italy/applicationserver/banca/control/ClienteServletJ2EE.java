...
@WebServlet(urlPatterns = {"/form-prelievo","/versamento", "/form-versamento", "/prelievo", })       //java annotation WebServlet: indicazione per il container (GlassFish) con le action della URI inviata dal client che la servlet intende gestire
public class ClienteServletJ2EE extends HttpServlet {
    ...
    protected void executeAction(HttpServletRequest request, HttpServletResponse response) //metodo chiamato dal container (GlassFish), a seguito di ricezione da parte sua del messaggio HTTP-Request, con metodo GET inviato dal client (browser)
		...
		switch (actionName.toLowerCase().trim()) {
			...
			case "/form-prelievo":
				actionFormPrelivo(request, response);
				break;
	...
	private
	static
	void actionVersamento(HttpServletRequest request, HttpServletResponse response) 
															throws ServletException, IOException {
													//throws BancaControlException, BancaModelException	{

		String messageToShow = UserMessages.msgEsitoVersamentoOk;				//default: messaggio per, successo esito apertura conto
	...
	private static void actionFormPrelivo(HttpServletRequest request, HttpServletResponse response) 
																throws ServletException, IOException {
	...
	private
	static
	void actionPrelievo(HttpServletRequest request, HttpServletResponse response) 
															throws ServletException, IOException {
													//throws BancaControlException, BancaModelException	{
